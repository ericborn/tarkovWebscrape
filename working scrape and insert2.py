...
###########################
# Issue using this method due to conflicting datatypes or something else that I couldn't figure out
# AttributeError: 'Table' object has no attribute 'isdigit' 
# Error happens to the above code also if you do not build the tables structure using weaponDF.head(0).to_sql command
###########################
...
#str(ins)
#
#weaponDF.to_sql(weaponProperties, con = engine, index = False)
